...
namespace WzComparerR2.Avatar.UI
{
    internal partial class AvatarForm : DevComponents.DotNetBar.OfficeForm
    {
        ...
        {
            if (MessageBoxEx.Show("Create Male Character？", "Notice") == DialogResult.OK)
            {
        ...
        {
            if (MessageBoxEx.Show("Create Female Character？", "Notice") == DialogResult.OK)
            {
        ...
        private void LoadCode(string code, int loadType)
        {
            ...
            if (matches.Count <= 0)
            {
                MessageBoxEx.Show("Unknown equipment code.", "Error");
                return;
            }
            ...
            if (characWz == null)
            {
                MessageBoxEx.Show("Character.wz not open", "Error");
                return;
            }
            ...
            {
                MessageBoxEx.Show("Avatar initialization failed.", "Error");
                return;
            }
