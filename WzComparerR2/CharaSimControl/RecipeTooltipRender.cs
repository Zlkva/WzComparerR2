...
namespace WzComparerR2.CharaSimControl
{
    public class RecipeTooltipRender : TooltipRender
    {
        ...
        private Bitmap RenderRecipe(out int picH)
        {
            ...
            g.DrawString("Generate items", GearGraphics.ItemDetailFont, GearGraphics.GreenBrush2, 13, picH);
            picH += 16;
            ...
            g.DrawString("Consumables", GearGraphics.ItemDetailFont, GearGraphics.GreenBrush2, 13, picH);
            picH += 16;
