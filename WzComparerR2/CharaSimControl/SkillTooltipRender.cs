...
namespace WzComparerR2.CharaSimControl
{
    public class SkillTooltipRender : TooltipRender
    {
        ...
        private Bitmap RenderSkill(out int picH)
        {
            ...
            //绘制desc
            picH = 35;
            GearGraphics.DrawString(g, "[Max Level：" + skill.MaxLevel + "]", GearGraphics.ItemDetailFont, 90, 270, ref picH, 16);
            if (sr.Desc != null)
            {
            ...
            if (skill.Level > 0)
            {
                ...
                picH += 4;
                GearGraphics.DrawString(g, "[Rank " + skill.Level + "]", GearGraphics.ItemDetailFont, 8, 272, ref picH, 16);
